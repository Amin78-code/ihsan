    ...
    return (
        <section className="bg-[#fff] pt-0 md:pt-[50px] md:pt-[80px] pb-[20px] md:pb-0">
            <div className="myContainer">
                <div className="max-w-[1590px] bg-[#F2F2F2] mx-auto pt-[40px] md:pt-[67px] pb-[20px] md:pb-[61px] slider-main mt-0 md:mt-[61px] px-[5%] xl:px-[160px]">
                    <h1 className='fpr text-[#0F2E3C] text-[35px] md:text-[70px] leading-[35px] md:leading-[80px] text-center'>Programs and seminars</h1>
                    <p className='fgr max-w-[1305px] text-[12px] md:text-[24px] leading-[16px] md:leading-[36px] text-center mx-auto pt-[30px]'>
