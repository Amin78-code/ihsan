  ...
  return (
    <section className="w-full pt-[37px] pb-[46px] md:py-[100px] bg-[#fff] relative overflow-hidden">
      <div className='myContainer'>
        ...
        <div className='flex flex-col md:flex-row flex-wrap justify-between gap-y-[21px] md:gap-y-[140px] gap-x-0 md:gap-x-[3%]'>

          <div className='w-full md:w-[48%] '>
            <h1 className='fpr text-[#0F2E3C] text-[32px] md:text-[100px] leading-[32px] md:leading-[100px] max-w-[633px]'>Our values and principals</h1>
          </div>
