  ...
  return (
    <section className="text-[#fff] pt-[50px] md:pt-[94px] pb-[50px] md:pb-[110px] relative overflow-hidden">
      ...
      <div className="myContainer relative z-[2]">
        <h1 className='fpr text-[32px] md:text-[100px] leading-[32px] md:leading-[100px] text-center'>Our approach</h1>
        ...
        <div className="flex flex-col md:flex-row flex-wrap gap-x-[0] md:gap-x-[1.5%] gap-y-[15px] md:gap-y-0 mt-[30px] md:mt-[107px]">
