            ...
            <div className="myContainer">
                ...
                <div id="accordion-collapse" className="mt-0 md:mt-[80px]">
                    <h2 id="accordion-collapse-heading-1" className="all-coll-heading" onClick={()=>toggle("1")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-5 font-medium text-left border-b-[1px] border-b-[1px] border-0 md:border border-b-0 border-gray-200 rounded-t-xl dark:border-gray-700 text-gray-900 dark:text-white" >
                    ...
                    <h2 id="accordion-collapse-heading-2" className="all-coll-heading" onClick={()=>toggle("2")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-5 font-medium text-left text-gray-500 border-b-[1px] border-b-[1px] border-0 md:border border-b-0 border-gray-200 dark:border-gray-700 dark:text-gray-400 focus:outline-none" >
                    ...
                    <h2 id="accordion-collapse-heading-3" className="all-coll-heading" onClick={()=>toggle("3")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-5 font-medium text-left text-gray-500 border-b-[1px] border-b-[1px] border-0 md:border border-gray-200 dark:border-gray-700 dark:text-gray-400 focus:outline-none" >
                    ...
                    <h2 id="accordion-collapse-heading-5" className="all-coll-heading" onClick={()=>toggle("5")}>
                        <button type="button" className="flex items-center justify-between w-full py-0 px-[5px] md:p-5 font-medium text-left text-gray-500 border-b-[1px] border-0 md:border border-gray-200 dark:border-gray-700 dark:text-gray-400 focus:outline-none" >
