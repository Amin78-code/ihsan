  ...
  return (
    <section className="text-[#fff] pt-[60px] md:pt-[120px] pb-[70px] md:pb-[140px] relative overflow-hidden">
      ...
      <div className="myContainer relative z-[2]">
        <h1 className='fpr text-[35px] md:text-[70px] leading-[35px] md:leading-[85px] text-center max-w-[900px] mx-auto'>Areas our individual coaching can help you with</h1>
